...
BOT_TOKEN = environ.get('BOT_TOKEN', "7573869434:AAGRlQ87MRhCRHiDSA7WKx2bMw-LV86FvOM")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002215419345') #Channel / Group Id for force sub ( make sure bot is admin )
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Ansari:ikra765592@cluster0.op7ki.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Verify
VERIFY = bool(environ.get('VERIFY', True)) # Verification On ( Truecaller ) / Off ( False )
...
#Channel & Group link 
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/xyzmoviesjerry')
